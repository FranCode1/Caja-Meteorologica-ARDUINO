...
#define MQ135_PIN A12             // Pin analógico donde está conectado el sensor MQ-135
#define LED_ALERTA_GAS 4          // Pin del LED indicador que se enciende si hay alta concentración
